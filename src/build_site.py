...
BIO = (
    "Network &amp; Automation Engineer with over nine years of experience in "
...
NAV = [("profile","Profile"),("about","About"),("skills","Capabilities"),
       ("network","Network"),("python","Python"),("credentials","Credentials"),
       ("contact","Contact")]
nav_html = "".join(
    f'<li><a href="#{i}"><span class="nav-node"></span>{label}</a></li>' for i,label in NAV)
...
/* ---------- main ---------- */
main{{padding:0 clamp(24px,5vw,72px)}}
...
footer{{padding:30px 0 50px;font-family:var(--mono);font-size:11.5px;color:var(--dim);
...
<div class="wrap">
  ...
  <main>
    ...
    <section id="network" class="reveal">
    ...
    <section id="python" class="reveal">
    ...
    <footer>
      ...
      <span>Built static &middot; deployed on Cloudflare Pages</span>
    </footer>
  </main>
</div>
